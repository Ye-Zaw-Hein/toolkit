...
func main() {
	// create a variable of type toolkit.Tools, so we can use this variable
...
func main() {
	...
	http.HandleFunc("/upload", func(w http.ResponseWriter, r *http.Request) {
		...
		// the returned variable, files, will be a slice of the type toolkit.UploadedFile
...
### Calling a API & Get Formatted Response
