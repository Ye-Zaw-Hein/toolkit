...
func TestTools_PushJSONToRemote(t *testing.T) {
	...
	if err != nil {
		t.Error("failed to call remote call", err)
	}
}
...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	testTool.DownloadStaticFile(rr, req, "./testdata", "img.png", "lanscape.png")
	...
	if res.Header["Content-Disposition"][0] != "attachment; filename=\"lanscape.png\"" {
